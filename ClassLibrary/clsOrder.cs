...
namespace ClassLibrary { 
    ...
    public bool Find(int orderID)
    {
        ...
        //valid need finishing pg22 of Adding Validation middle layer
        public string Valid(string OrderDate, string Comments, string price)
        { 
            //create a string variable to store the error
            String Error = "";
            //create a temporary varaiable to store date values 
            DateTime DateTemp;
